...
class ASTGenSuite(unittest.TestCase):
	...
	VarDecl(y, FloatType, FloatLit(6.7))
])"""
    ...
    def test307_assign_with_array_literal(self):
        ...
        expect = """Program([
	FuncDecl(main, VoidType, [], None, BlockStmt([AssignStmt(Id(a), ArrayLit([IntegerLit(1), IntegerLit(2), IntegerLit(3), IntegerLit(4)])), AssignStmt(Id(b), ArrayLit([IntegerLit(1)]))]))
])"""
    ...
    def test371_idx_for_loops(self):
        ...
        """
        expect = """Program([
	FuncDecl(main, VoidType, [], None, BlockStmt([ForStmt(AssignStmt(Id(i), IntegerLit(1)), BinExpr(<, Id(i), IntegerLit(5)), BinExpr(+, Id(i), IntegerLit(1)), BlockStmt([]))]))
])"""
    ...
    def test373_while_dowhile_1(self):
        input = """
        main: function void (){   
            while(true){
                do{}
    ...
    def test374_while_dowhile_2(self):
        input = """
        main: function void (){   
            while(true)
                do{}
